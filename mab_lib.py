...
# In simple words, MadLibs is a game in which you write a story with missing words in it; 
# then, you can ask another player to fill in the blanks. As you are the only one who knows what’s in your story about,
# the result is often funny and silly.
...
story = "Most doctors agree that bicycle of" + verb_1 + "is a/an "+ adj_1 + "form of exercise." + verb_2 
+" a bicycle enables you to develop your "+ body_part + " muscles as well as " + adverb + " increase the rate of a "
+ body_part_2 + " beat. More "+ noun + " around the world "+ verb_3 +" bicycles than drive "+ animal +". No matter what kind of "+ noun_2 +"you "+ verb_4 
+ ", always be sure to wear a/an "+adj_2+ "helmet.Make sure to have " + color + " reflectors too! "
print(story)
